...
public class TestLocalCurrency extends TestFmwk {
    ...
    public void TestConsistency() {
        ...
        for (String locale : factory.getAvailable()) {
            ...
            Set<CurrencyDateInfo> targetCurrencyInfo = supplementalDataInfo.getCurrencyDateInfo(region);
            ...
            String checkPath = "//ldml/numbers/currencies/currency[@type=\"" + localCurrency + "\"]/symbol";
            ...
            if (localCurrencySymbol.equals(localCurrency) && !nonLocalizedOK.contains(localCurrency)) {
                errln("Currency symbol " + localCurrencySymbol + " for locale " + locale + " is not localized.");
            }
